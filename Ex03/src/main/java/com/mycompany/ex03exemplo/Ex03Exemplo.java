 ...
 */
package com.mycompany.ex03exemplo;

import entities.ContaAPagar;
import entities.PessoaFisica;
import gerenciadores.GerenciadorPessoaFisica;
...
public class Ex03Exemplo {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2: // Remover pessoa fisica
                    System.out.print("Remoção: Informe o nome da pessoa:");
                    nomeProcurado = reader.nextLine();

                    gerenciador.removerPessoa(nomeProcurado);
                    break;
                ...
                case 6://Procurar pessoa com maior saldo devedor
                    ...
                    System.out.println("A maior dívida é: " + pessoa.contabilizaDividaTotal());
    ...
    private static PessoaFisica criarPessoaFisicaComContas(Scanner leitor) {
        ...
        PessoaFisica pessoa = new PessoaFisica(nome, idade, cpf);
